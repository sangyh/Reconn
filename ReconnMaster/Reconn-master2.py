...
for j in Loc.keys():
    ...
    filepath=os.path.join('C:/wamp/www/ReconnMaster/html_files',filename)
    ...
    html="""
                ...
                <img id="MainImg" src="http://localhost:8000/ReconnMaster/Images/Image0.jpg" alt="WTH" style="width:300px;height:300px;"><br>
                ...
                <script>
                    ...
                    var imgs = [];
                     for (var i = 0;  i < 14; i++) {
                         imgs[i] = new Image();
                         imgs[i].src = "http://localhost:8000/ReconnMaster/Images/Image" + i + ".jpg";
                     }
                     count++;
...
#     filename="C:\wamp\www\ReconnMaster\\trial.html"
#     f=open(filename,'r')
#     text=f.read()
#
